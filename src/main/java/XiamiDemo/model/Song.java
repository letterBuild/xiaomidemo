package XiamiDemo.model;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import XiamiDemo.util.DecodeKaiserMatrix;
import XiamiDemo.util.GetBean;
...
public class Song {
	...
	@XStreamAlias("songId")
	private int songIdss;
	@XStreamAlias("albumId")
	private int albumIdss;
	...
	public int getSongIdss() {
		return songIdss;
	}

	public void setSongIdss(int songIdss) {
		this.songIdss = songIdss;
	}

	public int getAlbumIdss() {
		return albumIdss;
	}

	public void setAlbumIdss(int albumIdss) {
		this.albumIdss = albumIdss;
	}
